...
func request_PromotionAdmin_SetVoucherToCampaign_0(ctx context.Context, marshaler runtime.Marshaler, client PromotionAdminClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SetVoucherToCampaignRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.SetVoucherToCampaign(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_PromotionAdmin_SetVoucherToCampaign_0(ctx context.Context, marshaler runtime.Marshaler, server PromotionAdminServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SetVoucherToCampaignRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.SetVoucherToCampaign(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterPromotionAdminHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PromotionAdminServer) error {
	...
	mux.Handle("POST", pattern_PromotionAdmin_SetVoucherToCampaign_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/promotion.admin.PromotionAdmin/SetVoucherToCampaign", runtime.WithHTTPPathPattern("/api/app/v1/promotion-admin/campaigns/voucher/set"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_PromotionAdmin_SetVoucherToCampaign_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_PromotionAdmin_SetVoucherToCampaign_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterPromotionAdminHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PromotionAdminClient) error {
	...
	mux.Handle("POST", pattern_PromotionAdmin_SetVoucherToCampaign_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/promotion.admin.PromotionAdmin/SetVoucherToCampaign", runtime.WithHTTPPathPattern("/api/app/v1/promotion-admin/campaigns/voucher/set"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_PromotionAdmin_SetVoucherToCampaign_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_PromotionAdmin_SetVoucherToCampaign_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5, 2, 6}, []string{"api", "app", "v1", "promotion-admin", "campaigns", "voucher", "set"}, ""))
)
...
var (
	...
	forward_PromotionAdmin_SetVoucherToCampaign_0 = runtime.ForwardResponseMessage
)
